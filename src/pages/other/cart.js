            ...
            <Row>
                        ...
                        <tr key={i}>
                          ...
                          <td className="product-name">
                            ...
                            product.selectedProductSize ? (
                              <div className="product-variation">
                                <span>
                                  Cor: {product.selectedProductColor}
                                </span>
                          ...
                          <td className="total-price">
                            <span className="price">
                              R$: {(discountedPrice * product.quantity).toFixed(2)}
                            </span>
                          </td>
              ...
              <Col lg={5} className="ml-auto">
                <div className="cart-calculation-area">
                  <h2 className="space-mb--40">Total</h2>
                  <table className="cart-calculation-table space-mb--40">
                    <tbody>
                      ...
                      <tr>
                        <th>TOTAL</th>
                        <td className="total">R$: {cartTotalPrice.toFixed(2)}</td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <Col>
                <div className="item-empty-area text-center">
                  ...
                  <div className="item-empty-area__text">
                    <p className="space-mb--30">Nenhum item no carrinho</p>
                    <Link
